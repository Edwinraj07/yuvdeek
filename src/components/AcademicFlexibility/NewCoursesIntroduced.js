...
export const NewCoursesIntroduced = () => {
        ...
        <div className='row '>
          ...
          <div className='col-lg-12'>
            <div className='row'>
              ...
              <p className='custom-div text-center text-white'> 1.2.1 New Courses Introduced</p>
              </div>
              <div className='col-lg-3'>
          ...
          <div className='col-lg-12'>
            <div className='row'>
              ...
              <span className='custom-div text-center clr '>Details of New <br/></span><span className='text-center ml-4 clr'>Courses</span>
              </div>
              <div className='col-lg-1'>
              
              </div>
              <div className='col-lg-2 p-1 mb-5 mt-3 '>
              <span className='custom-div text-center clr  '>Minutes of Board of <br/><span className='text-center ml-5'> Studies</span></span>
              </div>
              <div className='col-lg-1'>
