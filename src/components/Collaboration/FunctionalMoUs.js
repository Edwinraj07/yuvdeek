        ...
        <div className='row '>
          ...
          <div className='col-lg-12'>
            <div className='row'>
              ...
              <p className='custom-div custom-div1  text-center text-white'> 3.7.2 Functional MoUs</p>
              </div>
              <div className='col-lg-3'>
          ...
          <div className='col-lg-12'>
            <div className='row'>
              ...
              <span className='custom-div text-center clr '>Functional MoUs <br/><span className='text-center '></span></span>
              </div>
              <div className='col-lg-1'>
              
              </div>
              <div className='col-lg-2 p-1 mb-5 mt-3 '>
              <span className='custom-div text-center  clr '>Activities  <br/><span className='text-center '>under MoUs </span></span>
              </div>
              <div className='col-lg-1'>
              
              </div>
              <div className='col-lg-3 p-1 mb-5 mt-3 '>
              <span className='custom-div text-center clr '>Photographs
