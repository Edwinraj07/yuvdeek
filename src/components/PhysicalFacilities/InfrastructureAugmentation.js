...
export const InfrastructureAugmentation = () => {
     ...
     <div className='row '>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white clr'> 4.1.4 Infrastructure
Augmentation</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <span className='custom-div text-center ml-3 clr'>Consolidated Statement for 
<br/><span className='text-center ml-3 clr'>Infrastructure Augmentation</span></span>
           </div>
           <div className='col-lg-1'>
