...
export const TeachersAwardedFellowship313 = () => {
     ...
     <div className='row '>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white clr'> 3.1.3 Teachers Awarded
Fellowship</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <span className='custom-div text-center ml-3 clr'>Award Letters
