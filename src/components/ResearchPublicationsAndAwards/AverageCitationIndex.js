...
export default function AverageCitationIndex() {
     ...
     <div className='row '>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white clr'> 3.4.5 Average Citation Index</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <span className='custom-div text-center ml-2 clr'>Document from Scopus 
<br/><span className='text-center ml-5  clr'>& WoS Indexed</span></span>
           </div>
           <div className='col-lg-1'>
