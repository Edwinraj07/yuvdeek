     ...
     <div className='row '>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white clr'> 3.4.6 H-Index</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <span className='custom-div text-center ml-2 clr'>Report of h-index on 


<br/><span className='text-center ml-4  clr'>scopus and Web of Science</span></span>
           </div>
           <div className='col-lg-1'>
