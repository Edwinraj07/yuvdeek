...
export const GrantsForResearchProjects321 = () => {
     ...
     <div className='row '>
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div '> 3.2. Resource Mobilization for Research</p>
           </div>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white clr'> 3.2.1 Grants For Research Projects</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <span className='custom-div text-center  clr'>E Copies of Grant Letters
