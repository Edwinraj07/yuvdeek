...
export const ResearchProjects322 = () => {
     ...
     <div className='row '>
       ...
       <div className='col-lg-12'>
         <div className='row'>
           ...
           <p className='custom-div text-center text-white'>23.2.2 Research Projects</p>
           </div>
           <div className='col-lg-3'>
       ...
       <div className='row col-lg-12 '>
        ...
        <div className='col-lg-4 mr-5  clr'>
            
            <p className="mt-5">E Copies of Grant Letters</p>
       ...
       <div className='col-lg-12  '>
         ...
         <div className='col-lg-2 '>
           ...
           <div className='col-lg-1 ml-4 clr'>
           <p>2018-2019</p>
           </div>
